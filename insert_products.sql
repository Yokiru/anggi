...
-- Insert Golden Eye Fireworks Products with Categories

-- Roman Candles (Category: Roman)
...
('Roman Candle 1.9" 8 Shots (GE 1908A)', 'Roman', 8, '-', 'https://images.unsplash.com/photo-1498931299472-f7a63a5a1cfa?w=400', false);
...
INSERT INTO products (name, category, shoot, duration, image_url, featured) VALUES
('Single Artillery Colorful 1.75" (GE.1001B/B)', 'Artillery', 1, '-', 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400', false),
